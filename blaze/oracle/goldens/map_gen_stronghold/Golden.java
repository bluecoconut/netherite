// Golden for map_gen_stronghold: canonical output from verified CPU reference driver (same harness/shims
// as core/map_gen_stronghold.h). Seeds 12345/0/7. Full verbatim Structure*Pieces Java paste is follow-up when
